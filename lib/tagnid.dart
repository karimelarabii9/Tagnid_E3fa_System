...
class TagnidPapers extends StatelessWidget {
  final String result;

  const TagnidPapers({super.key, required this.result});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                "توجه إلى مكتب التجنيد التابع لك ومعك الأوراق التالية",
                style: TextStyle(
                  fontFamily: 'Cairo',
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    _buildRequiredDocuments("١. بطاقة عسكرية ٧ جند"),
                    _buildRequiredDocuments("٢. اصل شهادة ميلاد"),
                    _buildRequiredDocuments("٣. فصيلة الدم"),
                    _buildRequiredDocuments("٤. اصل المؤهل الدراسي"),
                    _buildRequiredDocuments("٥. اصل صورة البطاقة"),
                    _buildRequiredDocuments("٦. اصل الفيش الجنائي"),
                  ],
                ),
              ),
            ),
